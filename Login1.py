...
class login_system:
    ...
    # Create Widgets
        ...
        self.bg1_icon=ImageTk.PhotoImage(file=r"E:\human_action_reconization\L.jpg")

        self.bg_icon=ImageTk.PhotoImage(file=r"E:\human_action_reconization\L.jpg")
        self.user_icon=ImageTk.PhotoImage(file=r"E:\human_action_reconization\u1.png")
        self.pass_icon=ImageTk.PhotoImage(file=r"E:\human_action_reconization\p1.jpg")
